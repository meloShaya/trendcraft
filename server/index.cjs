...
app.listen(PORT, () => {
  console.log(`✅ Minimal server is listening on http://localhost:${PORT}`);
  console.log('This message should appear, and the terminal should NOT exit.');
